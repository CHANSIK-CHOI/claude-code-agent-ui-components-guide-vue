    ...
    <section class="alertGuidePage__section">
      ...
      <div class="alertGuidePage__group">
        ...
        <p class="alertGuidePage__note">
          가장 일반적인 사용 패턴. ok 버튼 또는 ✕ 버튼을 클릭하면 팝업이 닫힙니다.
        </p>
        <div class="alertGuidePage__row">
          <button type="button" class="alertGuidePage__demoBtn" @click="showBasic">
            기본 Alert 열기
          </button>
        </div>
...
open({ message: '저장됐습니다.' })</code></pre>
      ...
      <div class="alertGuidePage__group">
        ...
        <div class="alertGuidePage__row">
          <button type="button" class="alertGuidePage__demoBtn" @click="showWithTitle">
            타이틀 있는 Alert 열기
          </button>
        </div>
        <pre class="alertGuidePage__code"><code>open({ title: '안내', message: '처리가 완료됐습니다.' })</code></pre>
      </div>
    </section>
    ...
    <section class="alertGuidePage__section">
      ...
      <div class="alertGuidePage__group">
        <p class="alertGuidePage__note">
          ok/닫기/ESC/dim 클릭으로 팝업이 닫힌 후 <code>onClose</code>가 호출됩니다.
          아래 결과 영역에서 콜백 호출 시점을 확인하세요.
        </p>
        <div class="alertGuidePage__row">
  ...
  onClose: () => { callbackCount++ },
    ...
    <section class="alertGuidePage__section">
      ...
      <div class="alertGuidePage__group">
        ...
        <pre class="alertGuidePage__code"><code>open({ message: '로그인이 필요합니다.', okLabel: '로그인' })</code></pre>
      </div>
    </section>
    ...
    <section class="alertGuidePage__section">
      ...
      <div class="alertGuidePage__group">
        <p class="alertGuidePage__note">
          버튼을 연속 클릭하면 여러 Alert이 z-index 순으로 쌓입니다.
          각각 독립적으로 닫힙니다.
        </p>
        <div class="alertGuidePage__row">
          <button type="button" class="alertGuidePage__demoBtn" @click="showMultiple">
            Alert 연속 3개 열기
          </button>
        </div>
      </div>
...
import { useAlert } from '~/components/popup'
