  ...
  <div class="SelectGuidePage">
    ...
    <header class="SelectGuidePage__header">
      ...
      <p class="SelectGuidePage__desc">
        ...
        내부적으로 <strong>Radix Vue</strong>를 사용해 키보드 탐색, 포커스 트랩,
        ARIA 처리를 자동으로 지원합니다.
      </p>
    </header>
    ...
    <section class="SelectGuidePage__section">
      ...
      <div class="SelectGuidePage__group">
        ...
        <p class="SelectGuidePage__note">
          ...
          <code>error-text</code>가 담당합니다.<br />
...
/&gt;</code></pre>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              드롭다운에 표시할 옵션 목록.<br />
              <code
                >SelectOption: { value: string; label: string; disabled?:
                boolean }</code
              >
            </td>
          </tr>
          ...
          <tr>
            ...
            <td><code>false</code></td>
            <td>
              에러 상태. <code>aria-invalid="true"</code> 자동 적용. 에러 메시지
              텍스트는 FormField 담당
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <code>filter</code> — 인라인 필터용 compact (padding 기반 높이,
              fit-content 너비)
            </td>
          </tr>
        </tbody>
      ...
      <div class="SelectGuidePage__delegationNote">
        ...
        <p>
          ...
          자동 배분됩니다. React의 <code>{...rest}</code> spreading과 동일한
        ...
        <table class="SelectGuidePage__delegationTable">
          ...
          <tbody>
            <tr>
              ...
              <td>
                폼 제출 시 필드명. Radix Vue가 hidden input을 자동 생성해 전송
              </td>
            </tr>
            <tr>
...
/&gt;</code></pre>
        <p>
          ※ <code>id</code>는 양쪽 제외 — 내부 <code>selectId</code>가 단독 처리
          (<code>&lt;label for&gt;</code> 연동)
        </p>
      </div>
